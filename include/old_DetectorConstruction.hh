...
#ifndef old_DetectorConstruction_h
#define old_DetectorConstruction_h 1
...
\sa Construct()
 */
class old_DetectorConstruction : public G4VUserDetectorConstruction
{
public:
  //! Constructor
  old_DetectorConstruction();
  //! Destructor
  ~old_DetectorConstruction();
public:
