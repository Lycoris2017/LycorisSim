...
#include "old_DetectorConstruction.hh"
...
old_DetectorConstruction::old_DetectorConstruction()
{
	//--------- Material definition ---------
	DefineMaterials();
...
void old_DetectorConstruction::DefineMaterials() 
{
...
void old_DetectorConstruction::ComputeParameters() 
{
...
void old_DetectorConstruction::ConstructField() 
{
...
G4VPhysicalVolume* old_DetectorConstruction::Construct()
{
...
G4VPhysicalVolume* old_DetectorConstruction::ConstructGeometry()
{
	/*copy numbers
	 * 0: world with air
	...
	firstExtraSiSensorPart = new G4PVPlacement( rot1, //no rotation
	                                            ...
	                                            airInMagnetLogic,//its mother volume
	                                            false,
	                                            1000, fCheckOverlaps);//copy number
	}
	...
	firstExtraNSiSensorPart = new G4PVPlacement( rot1, //no rotation
						     ...
						     airInMagnetLogic,//its mother volume
						     false,
	                                             1001, fCheckOverlaps);//copy number
	}
	...
	firstExtraNNSiSensorPart = new G4PVPlacement( rot1, //no rotation
						     ...
						     airInMagnetLogic,//its mother volume
						     false,
	                                              1002, fCheckOverlaps);//copy number
	}
	...
	fourthExtraSiSensorPart = new G4PVPlacement(rot2, //no rotation
							     ...
							     airInMagnetLogic,//its mother volume
							     false,
	                                            1010, fCheckOverlaps);//copy number
	}
	...
	fourthExtraNSiSensorPart = new G4PVPlacement(rot2, //no rotation
							     ...
							     airInMagnetLogic,//its mother volume
							     false,
	                                             1011, fCheckOverlaps);//copy number
	}
	if (NNlayers==true ) {
	//creating third extra layer of silicon sensor
	...
	fourthExtraNNSiSensorPart = new G4PVPlacement(rot2, //no rotation
							     ...
							     airInMagnetLogic,//its mother volume
							     false,
	                                              1012, fCheckOverlaps);//copy number
	...
	for ( int layerIdx = 0 ; layerIdx < (noOfFieldStrips) ; layerIdx++ )
		{
			...
			new G4PVPlacement(0,G4ThreeVector(0,0,position),innerFieldStripsLogic,"InnerFieldStrips",kaptonLogic,false,++stripCopyNum, fCheckOverlaps);
			
			position = (layerIdx+1)*halfFieldStripsLength*2/noOfFieldStrips-halfLPLength;
			new G4PVPlacement(0,G4ThreeVector(0,0,position),outerFieldStripsLogic,"OuterFieldStrips",kaptonLogic,false,++stripCopyNum, fCheckOverlaps);
